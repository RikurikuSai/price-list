<!-- 会社紹介動画タブ -->
    ...
    <script>
        ...
        function showContractOptions() {
            ...
            const contractCheckbox = document.querySelector('#youtube-discount .checkbox-item[data-value="contract"]');
            
            if(contractCheckbox && contractCheckbox.classList.contains('selected')) {
                if(contractOptions) contractOptions.style.display = 'block';
            } else {
                if(contractOptions) contractOptions.style.display = 'none';
